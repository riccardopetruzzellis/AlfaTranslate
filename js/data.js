...
const GLOSSARY = [
  ...
  },
  {
    ...
    category: "finance",
    tags: ["accounting", "financial_statement", "reporting"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["accounting", "financial_statement", "profitability", "reporting"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["income", "financial_statement", "top_line"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["profitability", "financial", "margin"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["profitability", "financial_result", "bottom_line"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["capital", "cost", "investment", "valuation"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["debt", "financing", "real_estate", "property", "loan"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["financing", "cost", "monetary", "rate"],
    related: ["fixed_floating_rate", "mortgage", "wacc", "discount_rate", "ebit"]
  },
  {
    id: "fixed_floating_rate",
    en: "Fixed rate / Floating rate",
    it: "Tasso fisso / Tasso variabile",
    definition: "Tasso d'interesse costante o agganciato a un parametro (es. Euribor).",
    category: "finance",
    tags: ["interest", "financing", "risk", "rate"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["accounting", "debt", "depreciation", "period"],
    related: ["depreciation", "mortgage", "debt_service", "ebitda"]
  },
  {
    id: "depreciation",
    en: "Depreciation",
    it: "Deprezzamento / Ammortamento beni materiali",
    definition: "Riduzione del valore di un bene materiale nel tempo.",
    category: "finance",
    tags: ["accounting", "asset", "value", "reduction"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["cash", "financial", "risk", "convertibility"],
  ...
  },
  {
    ...
    category: "finance",
    tags: ["debt", "mortgage", "financing", "restructuring"],
  ...
  },
  {
    ...
    category: "realestate",
    tags: ["performance", "leasing", "risk", "kpi"],
  ...
  },
  {
    ...
    category: "realestate",
    tags: ["property", "building", "shared", "space"],
    related: ["gla", "nia", "service_charge"]
  },
  {
    id: "gla",
    en: "Gross Leasable Area (GLA)",
    it: "Superficie lorda locabile",
    definition: "Superficie commerciale destinabile alla locazione.",
    category: "realestate",
    tags: ["area", "measurement", "leasing", "surface"],
    related: ["nia", "floor_plan", "vacancy_rate", "rent", "common_areas"]
  },
  {
    id: "nia",
    en: "Net Internal Area (NIA)",
    it: "Superficie netta interna",
  ...
  },
  {
    ...
    category: "realestate",
    tags: ["valuation", "analysis", "benchmark", "reference"],
    related: ["appraisal", "market_value"]
  },
  {
    id: "closing",
    en: "Closing",
    it: "Rogito / Chiusura compravendita",
    definition: "Atto finale di trasferimento della proprietà.",
    category: "realestate",
    tags: ["transaction", "legal", "ownership", "transfer"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["construction", "operations", "safety", "site"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["structural", "engineering", "construction", "ground"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["structural", "engineering", "wall", "support"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["structural", "concrete", "floor", "horizontal"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["structural", "engineering", "horizontal", "support"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["structural", "engineering", "vertical", "support"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["material", "structural", "construction", "concrete"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["material", "structural", "modern", "metal"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["material", "construction", "traditional", "brick"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["exterior", "protection", "structure", "envelope"],
    related: ["insulation", "waterproofing", "facade"]
  },
  {
    id: "insulation",
    en: "Insulation",
    it: "Isolamento (termico/acustico)",
    definition: "Materiali e tecniche per ridurre dispersioni termiche e rumori.",
    category: "construction",
    tags: ["energy", "thermal", "acoustic", "sustainability"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["protection", "moisture", "construction", "envelope"],
    related: ["foundation", "roofing", "facade", "cladding"]
  },
  {
    id: "hvac",
    en: "HVAC (Heating, Ventilation, Air Conditioning)",
    it: "Riscaldamento, ventilazione e condizionamento",
    definition: "Sistemi impiantistici per il comfort climatico.",
    category: "construction",
    tags: ["mechanical", "energy", "comfort", "systems", "sustainability"],
    related: ["mep", "insulation", "commissioning", "epc", "facility_management"]
  },
  {
    id: "mep",
    en: "MEP (Mechanical, Electrical, Plumbing)",
    it: "Impianti meccanici, elettrici e idraulici",
    definition: "Insieme degli impianti tecnologici di un edificio.",
    category: "construction",
    tags: ["engineering", "systems", "building", "technical"],
    related: ["hvac", "plumbing", "wiring", "bim", "commissioning"]
  },
  {
    id: "plumbing",
    en: "Plumbing",
    it: "Impianto idraulico",
    definition: "Sistema di tubazioni per acqua e scarichi.",
    category: "construction",
    tags: ["water", "systems", "mechanical", "pipes"],
    related: ["mep", "hvac", "waterproofing"]
  },
  {
    id: "wiring",
    en: "Wiring / Electrical system",
    it: "Impianto elettrico",
    definition: "Insieme di cavi, quadri e dispositivi elettrici.",
    category: "construction",
    tags: ["electrical", "systems", "building", "power"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["construction", "safety", "temporary", "height"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["earthworks", "construction", "foundation", "ground"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["deconstruction", "construction", "removal", "site"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["renovation", "existing_building", "improvement", "upgrade"],
    related: ["retrofit", "restoration", "capex", "greenfield_brownfield"]
  },
  {
    id: "retrofit",
    en: "Retrofit",
    it: "Riqualificazione / Adeguamento",
    definition: "Adeguamento tecnologico o energetico di un edificio esistente.",
    category: "construction",
    tags: ["upgrade", "energy", "existing_building", "sustainability"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["construction", "execution", "specialized", "trades"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["safety", "legal", "construction", "workers", "regulation"],
  ...
  },
  {
    ...
    category: "construction",
    tags: ["safety", "equipment", "construction", "protection"],
...
const GLOSSARY_MAP = {};
GLOSSARY.forEach(term => { GLOSSARY_MAP[term.id] = term; });

// Category metadata
const CATEGORIES = {
  all:          { label: "Tutti",       icon: "🔍", color: "#6B7280" },
  finance:      { label: "Finance",     icon: "💹", color: "#3B82F6" },
  realestate:   { label: "Real Estate", icon: "🏢", color: "#10B981" },
  construction: { label: "Edilizia",    icon: "🏗️",  color: "#F59E0B" }
};
